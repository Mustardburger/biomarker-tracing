...
def main():
    ...
    atlas_path = "/sc/arion/projects/DiseaseGeneCell/Huang_lab_project/BioResNetwork/Phuc/datasets/atlas_data/analysis/tabula_sapiens/cell_tissue/specificity_metric/tabula_sapiens_pseudobulk_gene_exp_logcounts.tsv"
    atlas_smal_path = "/sc/arion/projects/DiseaseGeneCell/Huang_lab_project/BioResNetwork/Phuc/projects/Alzheimer/human_atlas/sub_projects/plasma_proteome/results/atlas_smal_merged.tsv"
    save_path = f"/sc/arion/projects/DiseaseGeneCell/Huang_lab_project/BioResNetwork/Phuc/projects/Alzheimer/human_atlas/sub_projects/plasma_proteome/results/{dis_type}_popu-{popu_type}/elastic_kfold_ver2"
    ...
    for disease in sorted(diseases):
        ...
        args = [atlas_path, atlas_smal_path, base_path, save_full_path, dis_name]
